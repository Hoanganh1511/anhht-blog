...
export function LoginPopup({ onClose }: { onClose: () => void }) {
  return (
    <div className="flex flex-col">
      <h2 className="text-xl font-bold text-ink text-center mb-3">
        Đăng nhập
      </h2>
      <p className="text-sm text-muted text-center leading-relaxed mb-8">
        Đăng nhập để nhắn tin và<br />theo dõi nội dung mới.
      </p>
      ...
      >
        <GoogleIcon />
        <span className="font-medium text-sm text-ink">Tiếp tục với Google</span>
      </SignInButton>
